package org.app2automate.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.app2automate.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.app2automate.repository.UserRepository.USERS_BY_EMAIL_CACHE);
